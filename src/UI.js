...
community_map.renderPostcodeLookup = function (options) {
    ...
    var html = '<div class="postcode_lookup"><label for="map_search_by_location">Search by location: </label><input type="text" placeholder="postcode or address" class="postcode_input" id="map_search_by_location"  /><input type="button" class="postcode_submit" alt="search map" value="location search" /><a class="clear_postcode_search">&raquo; Clear search</a></div>';
